<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fechanac" class="form-control @error('fechanac') is-invalid @enderror" value="{{ old('fechanac', $paciente?->fechanac) }}" id="fechanac" placeholder="Fechanac">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="correo" class="form-control @error('correo') is-invalid @enderror" value="{{ old('correo', $paciente?->correo) }}" id="correo" placeholder="Correo">
            {!! $errors->first('correo', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="historial" class="form-label">{{ __('Historial') }}</label>
            <input type="text" name="historial" class="form-control @error('historial') is-invalid @enderror" value="{{ old('historial', $paciente?->historial) }}" id="historial" placeholder="Historial">
            {!! $errors->first('historial', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="estado" class="form-label">{{ __('Estado') }}</label>
            <input type="text" name="estado" class="form-control @error('estado') is-invalid @enderror" value="{{ old('estado', $paciente?->estado) }}" id="estado" placeholder="Estado">
